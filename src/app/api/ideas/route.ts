    ...
    const result = await IdeaService.createIdea(
      {
        ...
        requiereVoluntarios: validatedData.requiereVoluntarios,
        cantidadVoluntarios: validatedData.cantidadVoluntarios,
        perfilVoluntarios: validatedData.perfilVoluntarios,
